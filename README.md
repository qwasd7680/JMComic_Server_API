...
示例:http://192.168.31.42:11111/114514

返回结果:
```json
{"status":"ok","app":"jmcomic_server_api","latency":"644"}
```
...
示例:http://192.168.31.42:11111/search/原神/1
...
返回示例:
```json
{"status":"success","tag":["全彩","巨乳","强姦","强暴","CG集","AI绘图","中文"],"id":"923ea582-80d5-11f0-8000-dca6325c753b"}
```
这里就有点不一样了。

首先，tag不用多说，参数id是后续获得封面的重要参数，让我们看下一步
...
示例:http://192.168.31.42:11111/get/cover/923ea582-80d5-11f0-8000-dca6325c753b
